...
<div class="modal-header">
	<h3> <?php echo $result->name ?> Town </h3>
</div>
	...
	<div class="row">
        <table class="table ">
            ...
            <tr>
                ...
                <td><label><?php echo $result->driver ?></label></td>
            </tr>
        </table>
    </div>
    <!-- /.end row -->
...
<div class="modal-footer" class="clearfix">
	<!-- left footer -->
	<div class="pull-left">
		<?php echo anchor((site_url('driver/town'.'/edit/'.$result->town_id))  , "Edit", array('class'=>'btn btn-primary')); ?>
