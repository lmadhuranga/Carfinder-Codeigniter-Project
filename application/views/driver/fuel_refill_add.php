...
<div class="modal-body">
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            ...
            <?php 
                ...
                echo $CI->fuel_center_model->get_as_dropdown('fuel_center_id',set_value('fuel_center_id'),array('fuel_center_id','name'),'Fuel center','');
            ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="date" name="date" type="text" value="<?php echo set_value('date',$today); ?>" required="required" maxlength=""  />
