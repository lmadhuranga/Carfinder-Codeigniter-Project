...
<div class="modal-body">
    ...
    <?php $CI->load->model('driver_model'); ?>
     <input type="hidden" name="driver_id" id="driver_id" value="<?php echo $CI->driver_model->get_current_user_id() ?>">
<!-- 
    <div class="control-group">
        ...
        <div class="controls">
            <?php 
                ...
                echo $CI->driver_model->get_as_dropdown('driver_id',set_value('driver_id'),array('driver_id','first_name'),'Driver','');
            ?>
    ...
    <div class="control-group">
        ...
        <div class="controls"> 
            <?php 
                ...
                echo $CI->town_model->get_as_dropdown('town_id',set_value('town_id'),array('town_id','name'),'Town','');
            ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php 
                ...
                echo $CI->vehicle_status_model->get_as_dropdown('vehicle_status_id',set_value('vehicle_status_id'),array('vehicle_status_id','status'),'Vehicle status','');
            ?>
...
<div class="modal-footer">
	<div class="clearfix">
		...
		<div class="pull-left">
			...
			<?php echo anchor((site_url('driver/vehicle_log')) , 'Vehicle log list', array('class'=>'btn btn-default')); ?>		
		</div>
		<!-- footer right  -->
