...
<div class="modal-body">
    ...
    <table class="table ">
        ...
        <tr>
            ...
            <td><label><?php echo anchor(site_url('driver/vehicle/view/'.$result->vehicle_id), $result->register_no); ?></label></td>
        </tr>

        <tr>
            <td><label>Driver</label></td>
            <td><label><?php echo anchor(site_url('driver/driver/view/'.$result->driver_id), $result->driver_name); ?></label></td>
        </tr>

        <tr>
            <td><label>Vehicle status</label></td>
            <td><label><?php echo anchor(site_url('driver/vehicle_status'), $result->vehicle_status); ?></label></td>
        </tr>
...
<div class="modal-footer" class="clearfix">
    <!-- left footer -->
    <div class="pull-left">
        <?php echo anchor((site_url('driver/vehicle_log'.'/edit/'.$result->vehicle_log_id))  , "Edit", array('class'=>'btn btn-primary')); ?>
