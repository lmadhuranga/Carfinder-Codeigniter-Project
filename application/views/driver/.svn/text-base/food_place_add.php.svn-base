    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="control-group">
                ...
                <div class="controls">                              
                    <input readonly id="lat" name="lat" type="text" value="<?php echo set_value('lat'); ?>" required="required" maxlength="10"  />
            ...
            <div class="control-group">
                ...
                <div class="controls">                              
                    <input readonly id="lon" name="lon" type="text" value="<?php echo set_value('lon'); ?>" required="required" maxlength="10"  />
