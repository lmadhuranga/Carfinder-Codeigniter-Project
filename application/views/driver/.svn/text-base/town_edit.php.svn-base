	...
	<div class="col-md-4">
		<div class="modal-body"> 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input readonly id="lat" name="lat" type="text" value="<?php echo $result->lat ?>"  maxlength="15" required />
			...
			<div class="control-group">
				...
				<div class="controls">
					<input readonly id="lon" name="lon" type="text" value="<?php echo $result->lon ?>"  maxlength="15"  required/>
...
<div class="modal-footer">
	<div class="clearfix">
		<div class="pull-left">
			...
			<?php echo anchor((site_url('driver/town')) , 'Town list', array('class'=>'btn btn-default')); ?>
		</div>
