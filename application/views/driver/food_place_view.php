    ...
    <div class="row">
        <table class="table ">
            ...
            <tr>
                ...
                <td><label><a href="<?php echo(site_url('driver/town/view/'.$result->town_id)); ?>"><?php echo $result->town_name ?></a></label></td>
            </tr>
...
<div class="modal-footer" class="clearfix">
	<!-- left footer -->
	<div class="pull-left">
		<?php echo anchor((site_url('driver/food_place'.'/edit/'.$result->food_place_id))  , "Edit", array('class'=>'btn btn-primary')); ?>
