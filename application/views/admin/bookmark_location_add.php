...
<div class="modal-body">
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="lat" name="lat" type="text" value="<?php echo set_value('lat'); ?>"  maxlength=""  readonly />
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="lon" name="lon" type="text" value="<?php echo set_value('lon'); ?>"  maxlength="" readonly />
