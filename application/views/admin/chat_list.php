...
for($i=0;$i<count($results);$i++)
{
    ...
    $results[$i]['Delete']   = anchor(site_url('admin/chat/delete/'.$id[0]),"<i class='glyphicon glyphicon-remove-sign'></i>",array('onClick'=>'return deletechecked(\' '.site_url('admin/chat/delete/'.$id[0]).' \')', 'title'=>'Delete'));
