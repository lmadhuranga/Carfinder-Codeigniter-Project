...
<!-- 	<div class="control-group">
	...
	<div class="controls">                              
		<input id="image" name="image" type="text" value="<?php echo set_value('image'); ?>"  maxlength="45"  />
	 ...
	 <div class="control-group">
        <span class="btn btn-success fileinput-button">
            ...
            <input type="hidden" name="image" id="image" value="<?php echo set_value('image','default.png') ?>">
        </span>
        ...
        <!-- Image preview --> 
        <img src="<?php echo base_url('upload/img/vehicle_status/'.set_value('image','default.png')) ?>" width="64px" id='image_pre'/>
    </div>
    <!-- /.control-group -->
