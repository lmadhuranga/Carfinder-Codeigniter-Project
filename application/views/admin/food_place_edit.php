    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input readonly id="lat" name="lat" type="text" value="<?php echo $result->lat ?>" required="required" maxlength="10"  readonly />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input readonly id="lon" name="lon" type="text" value="<?php echo $result->lon ?>" required="required" maxlength="10" readonly />
...
<!-- 
            ...
            <div class="control-group">
                ...
                <!-- Image preview -->
                <?php $image_path = 'upload/img/food_place/'.$result->image; ?>
