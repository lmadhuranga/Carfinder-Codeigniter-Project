...
<div class="modal-body">
	...
	<input type="hidden" value="<?php echo $result->brand_id; ?>" id="brand_id" name="brand_id">

	<div class="control-group">
		<label class="control-label" for="name">Name<span class="required">*</span></label>                                
		<div class="controls">
			<input id="name" name="name" type="text" value="<?php echo $result->name ?>" required="required" maxlength="10" />
...
<!-- 	<div class="control-group">
	...
	<div class="controls">
		<input id="image" name="image" type="text" value="<?php echo $result->image ?>" required="required" maxlength="30" />
     ...
     <div class="control-group">
        ...
        <!-- Image preview -->
        <?php $image_path = 'upload/img/brand/'.$result->image; ?>
