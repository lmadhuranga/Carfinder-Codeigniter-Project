...
<div class="modal-footer" class="clearfix">
    <!-- left footer -->
    <div class="pull-left">
        <?php echo anchor((site_url('admin/driver'.'/edit/'.$result->driver_id))  , "Edit", array('class'=>'btn btn-primary')); ?>
        <?php echo anchor((site_url('admin/driver')) , 'Cancel', array('class'=>'btn btn-default')); ?>
    </div>
    <!-- right footer  -->
