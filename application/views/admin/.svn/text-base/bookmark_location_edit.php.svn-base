...
<div class="control-group">
    ...
    <div class="controls">
        <input id="lat" name="lat" type="text" value="<?php echo $result->lat ?>"  maxlength="" readonly/>
...
<div class="control-group">
    ...
    <div class="controls">
        <input id="lon" name="lon" type="text" value="<?php echo $result->lon ?>"  maxlength="" readonly/>
