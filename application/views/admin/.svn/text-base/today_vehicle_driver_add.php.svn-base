 ...
 <div class="modal-header">
	<h3>Add a Today vehicle driver</h3>
</div>
...
<div class="modal-body">
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="start_time" name="start_time" type="text" value="<?php echo set_value('start_time',date('Y-m-d ')); ?>"  maxlength=""  />
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="end_time" name="end_time" type="text" value="<?php echo set_value('end_time',date('Y-m-d ')); ?>"  maxlength=""  />
