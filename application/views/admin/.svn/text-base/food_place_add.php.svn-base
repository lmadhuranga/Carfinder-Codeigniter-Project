...
<div class="modal-body">
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="control-group">
                <label for="lat">Lat<span class="required">*</span></label> 
                <div class="controls">                              
                    <input readonly id="lat" name="lat" type="text" value="<?php echo set_value('lat'); ?>" required="required" maxlength="10" readonly  />
            ...
            <div class="control-group">
                <label for="lon">Lon<span class="required">*</span></label> 
                <div class="controls">                              
                    <input readonly id="lon" name="lon" type="text" value="<?php echo set_value('lon'); ?>" required="required" maxlength="10" readonly />
...
<!-- 
            <div class="control-group">
                ...
                <div class="controls">                              
                    <input id="image" name="image" type="text" value="<?php echo set_value('image'); ?>" required="required" maxlength="200"  />
    ...
    <div class="control-group">
        ...
        <!-- Image preview -->
        <?php $image_path = 'upload/img/food_place/'.set_value('image','default.jpg'); ?>
...
$(function () {
    ...
    var url = window.location.hostname === 'blueimp.github.io' ?
                '//jquery-file-upload.appspot.com/' : '<?php echo site_url("admin/food_place/do_upload") ?>';
