...
<div class="modal-body">
  ...
  <input type="hidden" value="<?php echo $result->device_id; ?>" id="device_id" name="device_id">
...
<div class="control-group">
    <label class="control-label" for="authenticate_code">Authenticate code<span class="required">*</span></label>                                
    <div class="controls">
        <input id="authenticate_code" name="authenticate_code" type="text" value="<?php echo $result->authenticate_code ?>" required="required" maxlength="250" />
...
<div class="control-group">
    <label class="control-label" for="device_expire_date">Device expire date</label>                                
    <div class="controls">
        <input id="device_expire_date" name="device_expire_date" type="text" value="<?php echo $result->device_expire_date ?>"  maxlength="" />
...
<div class="control-group">
    <label class="control-label" for="imei">Imei<span class="required">*</span></label>                                
    <div class="controls">
        <input id="imei" name="imei" type="text" value="<?php echo $result->imei ?>" required="required" maxlength="20" />
    ...
    <div class="control-group">
        ...
        <!-- Image preview -->
        <?php $image_path = 'upload/img/device/'.$result->image; ?>
...
<div class="modal-footer">
  <div class="clearfix">
     <div class="pull-left">
        ...
        <?php echo anchor((site_url('admin/device')) , 'Device list', array('class'=>'btn btn-default')); ?>
    </div>
