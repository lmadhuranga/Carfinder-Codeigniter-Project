...
<div class="modal-body">
  ...
  <input type="hidden" value="<?php echo $result->vehicle_id; ?>" id="vehicle_id" name="vehicle_id">

  <div class="control-group">
    <label class="control-label" for="register_no">Register no<span class="required">*</span></label>                                
    <div class="controls">
        <input id="register_no" name="register_no" type="text" value="<?php echo $result->register_no ?>" required="required" maxlength="15" />
...
<div class="control-group">
    ...
    <div class="controls">
        <input id="color" name="color" type="text" value="<?php echo $result->color ?>" required="required" maxlength="10" />
...
<div class="control-group">
    <label class="control-label" for="tank_liter">Tank liter</label>                                
    <div class="controls">
        <input id="tank_liter" name="tank_liter" type="number" value="<?php echo $result->tank_liter ?>"  required="required" maxlength="11" />
...
<div class="control-group">
    ...
    <div class="controls">
        <!-- <input id="brand_id" name="brand_id" type="dropdown" value="<?php echo $result->brand_id ?>" required="required" maxlength="11" /> -->
        <?php 
            $CI->load->model('brand_model');
            echo $CI->brand_model->get_as_dropdown('brand_id',$result->brand_id,array('brand_id','name'),'Brand','');
        ?>
...
<div class="control-group">
    <label class="control-label" for="vehicle_type_id">Vehicle type<span class="required">*</span></label>                                
    <div class="controls">
        <!-- <input id="vehicle_type_id" name="vehicle_type_id" type="dropdown" value="<?php echo $result->vehicle_type_id ?>" required="required" maxlength="11" /> -->
        <?php 
            $CI->load->model('vehicle_type_model');
            echo $CI->vehicle_type_model->get_as_dropdown('vehicle_type_id',$result->vehicle_type_id,array('vehicle_type_id','type'),'Vehicle Type','');
        ?>
    ...
    <div class="control-group">
        <label for="maintain_km">Current meter value</label> 
        <div class="controls">
            <label for=""><?php echo $result->meter_value ?></label>
        </div>
    </div>

    <div class="control-group">
        <label for="starting_km">Last maintained km</label> 
        <div class="controls">                              
            <input id="starting_km" name="starting_km" type="number" value="<?php echo $result->starting_km; ?>"  maxlength="3" maxvalue='1000'  />
    ...
    <div class="control-group">
        ...
        <div class="controls">                              
            <input id="maintain_km" name="maintain_km" type="number" value="<?php echo $result->maintain_km; ?>"  maxlength="3" maxvalue='1000'  />
...
<div class="control-group">
    ...
    <div class="controls">
        <!-- <input id="status" name="status" type="dropdown" value="<?php echo $result->status ?>"  maxlength="1" /> -->
        <?php echo
    ...
    <div class="control-group">
        <label class="control-label" for="fuel_type_id">Fuel type<span class="required">*</span></label>                                
        <div class="controls">
            <!-- <input id="fuel_type_id" name="fuel_type_id" type="dropdown" value="<?php echo $result->fuel_type_id ?>" required="required" maxlength="1" /> -->
            <?php 
                $CI->load->model('fuel_type_model');
                echo $CI->fuel_type_model->get_as_dropdown('fuel_type_id',$result->fuel_type_id,array('fuel_type_id','name'),'Vehicle Type','');
            ?>
    ...
    <!-- <div class="control-group">
        ...
        <div class="controls">
            <input id="image" name="image" type="text" value="<?php echo $result->image ?>" required="required" maxlength="100" />
    ...
    <div class="control-group">
        ...
        <!-- Image preview -->
        <?php $image_path = 'upload/img/vehicle/'.$result->image; ?>
