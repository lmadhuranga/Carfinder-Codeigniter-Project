<div class="modal-header">
	<h3>Edit Website package</h3>
</div>
<?php echo form_open(current_url()); ?>
<div class="modal-body">

	<!-- <h2>Website_package</h2> -->


	<?php echo $custom_error; ?>
    <input type="hidden" value="<?php echo $result->website_package_id; ?>" id="website_package_id" name="website_package_id">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="title" name="title" type="text" value="<?php echo $result->title ?>" required="required" maxlength="15" />
    ...
    <div class="control-group">
        <label class="control-label" for="pub_date">Publish date<span class="required">*</span></label>                                
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="exp_date">Expire date</label>                                
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls">
             <textarea  id="content" name="content"   style="width:100%"><?php echo $result->content ?></textarea>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo form_dropdown('type', array(''=>'Select  type','1'=>'Wedding','2'=>'Taxi'), $result->type,'');  ?>
    ...
    <div class="control-group">
        <span class="btn btn-success fileinput-button">
            ...
            <input type="hidden" name="image" id="image" value="<?php echo image_set_value($result->image) ?>">
        </span>
        ...
        <?php $image_path = "upload/img/website_package/".image_set_value($result->image); ?>
