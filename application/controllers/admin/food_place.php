...
class Food_place extends Admin_Controller
{
	...
	function index()
	{
        ...
        //paging
        $config['base_url'] = site_url('admin/food_place/index');
        ...
        $this->data['sub_view'] = 'admin/food_place_list';
    ...
    {    
        ...
        {               
            ...
            if ($this->food_place_model->save($data) == TRUE)
            {
                ...
                // or redirect
                redirect(site_url('admin/food_place/index/?msg_success=Successfully details updated'));
            }
            else
            {
        ...
        $this->data['sub_view'] = 'admin/food_place_add';
    ...
    {   
        ...
        $this->data['sub_view'] = 'admin/food_place_edit';
        // load view
        $this->load->view('admin/_layout_modal',$this->data);
    ...
    function view($id1)
    {
        ...
        $this->data['sub_view'] = 'admin/food_place_view';
        // load view
        $this->load->view('admin/_layout_modal',$this->data);
    }
    ...
    { 
        ...
        {
           redirect(site_url('admin/food_place/index/?msg_error=Unsuccess full opertation'));
