...
class Notification extends Admin_Controller
{
	...
	function index()
	{
        ...
        //paging
        $config['base_url'] = site_url('admin/notification/index');
        ...
        $this->data['results'] = $this->notification_model->get_with_join('notification_id,admin.first_name AS admin_name,driver.first_name AS driver_name,messsage,call_center_id,notification.status,d_reject', NULL, FALSE,$config['per_page'],$this->uri->segment(4));
        $this->data['meta_title'] = $this->data['meta_title'].' - Notification list';
        $this->data['sub_view'] = 'admin/notification_list';
    ...
    {    
        ...
        {               
            // get form data        
            $data = $this->post_get_as_array(array('admin_id', 'driver_id', 'messsage', 'call_center_id', 'status', 'd_reject', ));
            ...
            if ($this->notification_model->save($data) == TRUE)
            {
                ...
                // or redirect
                redirect(site_url('admin/notification/index/?msg_success=Successfully details updated'));
            }
            else
            {
        ...
        $this->data['sub_view'] = 'admin/notification_add';
    ...
    {   
        ...
        $this->data['sub_view'] = 'admin/notification_edit';
        // load view
        $this->load->view('admin/_layout_modal',$this->data);
    ...
    function view($id1)
    {
        ...
        $this->data['sub_view'] = 'admin/notification_view';
        // load view
        $this->load->view('admin/_layout_modal',$this->data);
    }
    ...
    { 
         //     data not remove                       
        redirect(site_url('admin/notification/index/?msg_error=Access Deny')); 
    }
    /*--------------------------End of delete()---------------------------*/
