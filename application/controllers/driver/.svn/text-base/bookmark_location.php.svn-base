...
class Bookmark_location extends Driver_Controller
{
	...
	function index()
	{
        ...
        //paging
        $config['base_url'] = site_url('driver/bookmark_location/index');
        ...
        $this->data['sub_view'] = 'driver/bookmark_location_list';
    ...
    {    
        ...
        {               
            ...
            if ($this->bookmark_location_model->save($data) == TRUE)
            {
                ...
                // or redirect
                redirect(site_url('driver/bookmark_location/index/?msg_success=Successfully details updated'));
            }
            else
            {
        ...
        $this->data['sub_view'] = 'driver/bookmark_location_add';
    ...
    {   
        ...
        $this->data['sub_view'] = 'driver/bookmark_location_edit';
        // load view
        $this->load->view('driver/_layout_modal',$this->data);
    ...
    function view($id1)
    {
        ...
        $this->data['sub_view'] = 'driver/bookmark_location_view';
        // load view
        $this->load->view('driver/_layout_modal',$this->data);
    }
    ...
    { 
         // data removed                      
        if ($this->bookmark_location_model->delete($id)==TRUE)
        {
            redirect(site_url('driver/bookmark_location/index/?msg_success=Successfully details updated'));
        }
        else
        {
           redirect(site_url('driver/bookmark_location/index/?msg_error=Unsuccess full opertation'));
